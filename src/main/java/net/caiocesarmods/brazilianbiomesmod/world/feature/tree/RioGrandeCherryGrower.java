...
public class RioGrandeCherryGrower extends AbstractTreeGrower {
    @Nullable
    @Override
    protected Holder<? extends ConfiguredFeature<?, ?>> m_203525_(Random random, boolean b) {
        if (random.nextInt(10) == 0) {
            return ModConfiguredFeatures.RIO_GRANDE_CHERRY_FANCY_TREE;
        } else {
            return ModConfiguredFeatures.RIO_GRANDE_CHERRY_TREE;
        }
    }
}
